...
@Component({
  ...
  imports: [MatIconModule, MatButtonModule, FuseAlertComponent, MatTreeModule, RouterLink],
})
    ...
    this.appDir = [
      {
        ...
        children: [
          ...
          {
            name: 'modules/',
            children: [{ name: 'admin/' }, { name: 'auth/' }, { name: 'landing/' }],
          },
    ...
    this.generalDir = [
      ...
      },
      {
        ...
        children: [
          ...
          {
            name: 'styles/',
            children: [{ name: 'styles.scss' }, { name: 'tailwind.scss' }, { name: 'vendors.scss' }],
          },
          { name: 'index.html' },
          { name: 'main.ts' },
        ],
