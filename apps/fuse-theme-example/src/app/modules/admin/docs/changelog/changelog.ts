  ...
  changelog: any[] = [
    // v21.0.0
    {
      ...
      changes: [
        {
          type: 'Changed',
          list: ['(Dependencies) Updated Angular & Angular Material to v19', '(Dependencies) Updated other packages'],
        },
      ],
    },
    // v20.0.0
    ...
    // v17.2.0
    {
      ...
      changes: [
        ...
        {
          type: 'Fixed',
          list: ['(Angular Material) Fixed: Tooltip background color is not correct'],
        },
      ],
    },
    ...
    // v17.0.1
    {
      ...
      changes: [
        {
          type: 'Fixed',
          list: ['(@fuse/confirmation-dialog) Fixed: Extra padding on the confirmation dialogs'],
        },
      ],
    },
    ...
    // v15.1.0
    {
      ...
      changes: [
        ...
        {
          type: 'Fixed',
          list: ['(@fuse/overrides/angular-material) mat-hint position is not working correctly on fields'],
        },
      ],
    },
    // v15.0.0
    ...
    // v14.2.0
    {
      ...
      changes: [
        ...
        {
          type: 'Fixed',
          list: ["(layouts/dense) Fixed: Navigation appearance doesn't set correctly on small devices"],
        },
      ],
    },
    // v14.1.1
    {
      ...
      changes: [
        {
          type: 'Changed',
          list: ['(dependencies) Updated various packages', '(TailwindCSS) Moved to the new syntax on Tailwind config'],
        },
        {
          type: 'Fixed',
          list: [
    ...
    // v14.0.0
    {
      ...
      changes: [
        {
          type: 'Added',
          list: ['(FuseLoadingBar) Added the FuseLoadingBar component, its helper service and its interceptor'],
        },
        {
          type: 'Changed',
          list: [
    ...
    // v13.4.0
    {
      ...
      changes: [
        {
          type: 'Added',
          list: ['(dashboards/finance) Added finance dashboard', '(dashboards/crypto) Added crypto dashboard'],
        },
        {
          type: 'Changed',
          list: [
    ...
    // v13.3.1
    {
      ...
      changes: [
        {
          type: 'Fixed',
          list: ['(fuse/confirmation) Confirmation dialog colors are not optimized for the Dark mode'],
        },
      ],
    },
    // v13.3.0
    {
      ...
      changes: [
        {
          type: 'Added',
          list: ['(fuse/confirmation) A service to quickly configure and show confirmation dialogs'],
        },
        {
          type: 'Changed',
          list: [
    ...
    // v13.2.0
    {
      ...
      changes: [
        {
          type: 'Added',
          list: ['(fuse/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip'],
        },
        {
          type: 'Changed',
          list: [
    ...
    // v13.0.3
    {
      ...
      changes: [
        {
          type: 'Added',
          list: ['(apps/scrumboard) New, initial version of the Scrumboard app'],
        },
        {
          type: 'Changed',
          list: [
        ...
        {
          type: 'Fixed',
          list: ['(Angular Material) Density setting is not being applied correctly on Dark themes'],
        },
      ],
    },
    // v13.0.2
    ...
    // v13.0.0
    {
      ...
      changes: [
        {
          type: 'Added',
          list: ['(pages/settings) New Settings page', '(support) "_redirects" file for Netlify support'],
        },
        {
          type: 'Changed',
          list: [
    ...
    // v12.1.0
    {
      ...
      changes: [
        {
          type: 'Added',
          list: ['(apps/academy) New and improvement version of Academy app', '(icons) Material Solid icons'],
        },
        {
          type: 'Changed',
          list: [
        ...
        {
          type: 'Fixed',
          list: ['(apps/contacts) Clicking on the checkbox on Tag select panel acts weird'],
        },
      ],
    },
    // v12.0.0
