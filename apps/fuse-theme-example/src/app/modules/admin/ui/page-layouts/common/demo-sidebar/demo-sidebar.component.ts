    ...
    <div class="py-10">
      ...
      <div class="mx-6 mt-2">
        <div class="flex items-center">
          <mat-icon class="icon-size-5 mr-2" [svgIcon]="'heroicons_solid:circle-stack'"></mat-icon>
          <div class="text-lg font-semibold">Storage</div>
        </div>
        <div class="mt-4 flex flex-auto flex-col">
          <span class="mb-3 text-sm leading-none">19.9 GB of 100 GB used</span>
          <mat-progress-bar [mode]="'determinate'" [color]="'primary'" [value]="19.9"></mat-progress-bar>
        </div>
      </div>
      ...
      <div class="mx-6 mt-10">
        <div class="flex items-center">
          <mat-icon class="icon-size-5 mr-2" [svgIcon]="'heroicons_solid:users'"></mat-icon>
          <div class="text-lg font-semibold">Users</div>
        </div>
        <div class="mt-4 flex flex-auto flex-col">
          <span class="mb-3 text-sm leading-none">8 of 20 users used</span>
