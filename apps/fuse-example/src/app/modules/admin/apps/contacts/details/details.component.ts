...
export class ContactsDetailsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this._contactsService.countries$.pipe(takeUntil(this._unsubscribeAll)).subscribe((codes: Country[]) => {
    ...
    // Get the tags
    this._contactsService.tags$.pipe(takeUntil(this._unsubscribeAll)).subscribe((tags: Tag[]) => {
      this.tags = tags;
