...
@Component({
  ...
  template: `
    <div class="max-w-320 mx-auto w-full px-6 md:px-8">
      <div class="py-8">
        <!-- Info -->
        <div>
          ...
          <div>
            ...
            >
              <div class="flex min-h-full flex-auto">
                <!-- Navigation -->
                <div
                  class="h-192 flex-0 sticky top-0 hidden w-56 border-r border-gray-300 bg-gray-200 md:block dark:border-gray-700 dark:bg-gray-800"
                >
                  <div class="h-4"></div>
                  <div class="m-6 h-4 w-2/3 rounded bg-gray-300 dark:bg-gray-700"></div>
                  <div class="m-6 h-4 w-3/4 rounded bg-gray-300 dark:bg-gray-700"></div>
                  <div class="m-6 h-4 w-2/3 rounded bg-gray-300 dark:bg-gray-700"></div>
                  <div class="m-6 h-4 w-1/2 rounded bg-gray-300 dark:bg-gray-700"></div>
                  <div class="m-6 h-4 w-2/3 rounded bg-gray-300 dark:bg-gray-700"></div>
                </div>
                <!-- Content -->
                <div class="flex flex-auto flex-col">
                  <!-- Header -->
                  <div
                    class="relative z-10 flex h-16 items-center justify-end border-b border-gray-300 bg-gray-200 px-6 sm:px-10 dark:border-gray-700 dark:bg-gray-800"
                  >
                    <div class="h-6 w-6 rounded-full bg-gray-300 dark:bg-gray-700"></div>
                  </div>
                  <!-- Main -->
                  <div id="component-container" class="relative flex flex-auto flex-col">
                    <ng-container *ngComponentOutlet="selectedOption.component"></ng-container>
                  </div>
                  <!-- Footer -->
                  <div
                    class="relative z-10 flex h-14 items-center border-t border-gray-300 bg-gray-200 px-6 sm:px-10 dark:border-gray-700 dark:bg-gray-800"
                  >
                    <div class="h-4 w-32 rounded-full bg-gray-300 dark:bg-gray-700"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="mt-8 flex items-center justify-between">
              ...
              @if (selectedOption.link) {
                <div>
                  <a mat-flat-button [color]="'primary'" [routerLink]="selectedOption.link">
                    <mat-icon class="icon-size-4" [svgIcon]="'heroicons_mini:arrow-top-right-on-square'"></mat-icon>
  ...
  standalone: true,
  imports: [MatButtonToggleModule, FormsModule, NgClass, NgComponentOutlet, MatButtonModule, RouterLink, MatIconModule],
})
